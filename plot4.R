...
#plot
ggplot(data=sources,aes(x=factor(year), y=Emissions/1000)+ geom_bar(aes(fill=year),stat="identity",position = 'dodge')))+ xlab("Period (years)")+ylab("Total PM2.5 Emissions (kilotons)")+ggtitle("Coal Emissions over a certain period in USA")
